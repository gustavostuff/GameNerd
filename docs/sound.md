...
| Board sim | Island **K**: 8-voice math mix + `$FE40` smoke on ch1 + **WAVE** monitor. Host Play feeds Studio Track-1 demo into B1-B5 (silent; no host speaker). Full `$FE4x` hex protocol / cart BGM still later |
