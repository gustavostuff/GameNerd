...
#define R01E_PRG_BYTES 32768u /* fixed 32 KB window at $8000 (docs/graphics) */
...
/* Soft max for game logic (docs/selling_points): bars scale to this; red line = 100%. */
