...
| **Nano Sim** | [`sim/`](sim/) | IC/netlist board (islands, pins, wire settle). Nano parts only + SCR on canvas. Links emu core inside behavioral 1284. `./nano_sim`. Not a fullscreen emu. |
