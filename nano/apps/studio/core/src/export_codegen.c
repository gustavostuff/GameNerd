...
static int write_custom_logic(const char *c_dir, char *err_buf, size_t err_cap) {
    ...
    return write_text(path,
                      ...
                      "void r01_custom_on_init(R01GameCtx *ctx) {\n"
                      "    /* Player pose policy (custom_logic): 0 idle, 1 slide_x, 2 slide_up, 3 slide_down.\n"
                      "     * Runtime only draws the active state index — dir→state mapping lives here. */\n"
                      ...
                      "    /* slide_x returns to idle on release; slide_up/down keep their pose. */\n"
