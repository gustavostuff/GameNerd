...
TEST_MAIN() {
    ...
    r01_nano_fg_rgb(0, &r, &g, &b);
    EXPECT(r == 0xFF && g == 0xFF && b == 0xFF, "nano fg0 white");
    r01_nano_fg_rgb(1, &r, &g, &b);
    EXPECT(r == 0xFF && g == 0x20 && b == 0x20, "nano fg1 red");
    r01_nano_fg_rgb(6, &r, &g, &b);
    EXPECT(r == 0x30 && g == 0x60 && b == 0xFF, "nano fg6 blue");
