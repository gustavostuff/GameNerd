...
**Fork status:** Full copy of Retr01 Studio as a starting point. Paths and features still match the parent app. Next steps trim authoring/export to **Nano** constraints ([`../../docs/`](../../docs/)).

**Audio target (Nano):** two independent host/hardware channels — **Pulse (music)** and one **SFX** channel (noise or second pulse). Not the full five-lane BGM map. See [`../../docs/sound.md`](../../docs/sound.md).

Parent Studio docs below are still the copied baseline until Nano Studio diverges.
