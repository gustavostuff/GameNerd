...
/* Embedded emu Play session (export then cart-backed MAP preview). */
...
typedef struct UiState {
    ...
    int screen_layer; /* UI_SCREEN_LAYER_BG */
    ...
    int banks_plane;  /* UI_BANKS_PLANE_BG */
